...
<body>
    ...
    <div id="main">
        ...
        <div id="content" style="background-image: url('image/BG.png');">
            <h4 style="width:100%;text-align:center;color:#007bff">Dat hang khong thanh cong</h4><hr>
            <a href="Trasua?wantsearch=1"><input type="button" class="btn btn-block btn-outline-primary" style="margin-top:20px;" value="Dat hang lai?"></a>
        </div>
    </div>
</body>
</html>